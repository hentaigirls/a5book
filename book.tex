...
% documentinfomation
\newcommand{\license}{法律で認められている範囲を超えた無断複製・無断転載を禁じます。}
\input{info.txt}
\title{\booktitle}
\author{\bookauthor}
\date{\publishdate}
...
\newcommand{\topmargincm}[0]{-1.8cm}
\newcommand{\yokoboxwidth}[0]{0.5\textwidth} % 奥付やライセンス表示などの幅
\newcommand{\titleboxwidth}[0]{0.55\textwidth} % 作品タイトルの幅
\topmargin\topmargincm\advance\textwidth1.3cm
\ifsinglemode
\fancyhead[RO]{\thepage}
\fancyhead[LE]{\thepage}
\fancyheadoffset{0mm}
